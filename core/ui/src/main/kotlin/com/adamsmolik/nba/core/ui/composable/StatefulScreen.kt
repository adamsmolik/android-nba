...
import com.adamsmolik.nba.core.ui.error.ErrorUiModel
import com.adamsmolik.nba.core.ui.error.LocalErrorHandler
...
@Preview(name = "ProgressState", group = "Core UI")
@Composable
...
@Preview(name = "EmptyState", group = "Core UI")
@Composable
...
@Preview(name = "OfflineState", group = "Core UI")
@Composable
...
@Preview(name = "ErrorState", group = "Core UI")
@Composable
...
@Preview(name = "RetryState", group = "Core UI")
@Composable
